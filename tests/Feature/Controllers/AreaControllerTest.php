...
class AreaControllerTest extends TestCase
{
     ...
     * @test
     */
    public function it_displays_index_view_with_areas(): void
    {
        $areas = Area::factory()
            ->count(5)
            ->create();
     ...
     * @test
     */
    public function it_displays_create_view_for_area(): void
    {
     ...
     * @test
     */
    public function it_displays_show_view_for_area(): void
    {
     ...
     * @test
     */
    public function it_displays_edit_view_for_area(): void
    {
        $area = Area::factory()->create();
